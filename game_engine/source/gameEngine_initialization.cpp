...
void GameEngine::Initialize(){
    ...
    ****************************/
    ...
    if(appInfo->Uniform.b_uniform_graphics_object_dynamic){
        renderer->AddObjectUniformBuffer(CObjectManager::objectUBMapped);
        renderer->SetEnableObject(true);
    }
    if(appInfo->Uniform.b_uniform_graphics_text_dynamic){
    ...
    ****************************/
    ...
    b_uniform_compute = b_uniform_compute || appInfo->Uniform.b_storage_compute_material || appInfo->Uniform.b_storage_compute_triangle_vertex || appInfo->Uniform.b_storage_compute_triangle_index || appInfo->Uniform.b_storage_compute_bvhnode || appInfo->Uniform.b_storage_compute_sphere;
